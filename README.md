...
netblock_analyzer
```
Скрипт предложит выбрать список, задаст вопросы о количестве IP для пинга, спросит про тайм-аут и предложит сохранить результаты.

> [!WARNING]
> **Важно:** Изменение настроек пинга (количество IP и тайм-аут) вы выполняете на свой страх и риск. При агрессивном или слишком частом сканировании возможны блокировки со стороны целевых сетей или вашего провайдера. Автор не ручается за эти настройки и не несет ответственности за возможные последствия.
...
- **Цветовая индикация**: Использует ANSI-цвета в терминале: живые подсети отмечаются **зеленым**, а мертвые **красным**.
